...
const mockPlans = [
  { id: 'FREE', name: 'Free', price: 0, description: 'Free plan', features: [], popular: false, cta: 'Current', currentPlan: true },
  { id: 'PRO', name: 'Pro', price: 29, period: '/mois', description: 'Pro plan', features: [], popular: true, cta: 'Subscribe', currentPlan: false, stripePriceId: 'price_pro' },
]
