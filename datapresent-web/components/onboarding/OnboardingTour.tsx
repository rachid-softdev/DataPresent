...
export function OnboardingProvider({
  ...
  return (
    <OnboardingContext.Provider
      value={{ currentStep, steps, nextStep, prevStep, complete, isComplete }}
    >
      {children}
...
export const DEFAULT_ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    content:
      "Découvrez comment transformer vos données en présentations professionnelles en quelques clics.",
  },
  {
    id: "new-report",
    target: "new-report",
    ...
    content:
      'Cliquez sur "Nouveau rapport" pour importer vos données et laisser l\'IA générer votre présentation.',
    position: "bottom",
  },
  {
    id: "upload",
    ...
    content:
      "Glissez un fichier Excel, CSV ou PDF. Notre IA analysera automatiquement la structure et le contenu.",
    position: "bottom",
  },
  {
    id: "sector",
    ...
    content:
      "Finance, Marketing, RH ou SaaS : chaque secteur dispose de modèles et insights adaptés.",
    position: "bottom",
  },
  {
    id: "generate",
    ...
    content:
      "En quelques secondes, votre présentation est prête avec graphiques, KPIs et recommandations.",
    position: "top",
  },
  {
    id: "export",
