  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      if (retryCount > MAX_RETRIES) {
        ...
        console.warn(
          `[ReportDetailPoller] Max retries (${MAX_RETRIES}) reached for report ${reportId}`,
        );
        return;
      }
      ...
      try {
        ...
        console.warn(
          `[ReportDetailPoller] Fetch failed for report ${reportId}, retrying (${retryCount}/${MAX_RETRIES}):`,
          error,
        );
      }
    }, 5000);
