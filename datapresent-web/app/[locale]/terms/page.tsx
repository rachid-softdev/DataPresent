  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="app-heading app-heading-xl mb-8">Conditions d&apos;utilisation</h1>
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p>
              En accédant et en utilisant DataPresent, vous acceptez d&apos;être lié par ces
              conditions d&apos;utilisation. Si vous n&apos;acceptez pas ces conditions, veuillez ne
          ...
          <section>
            ...
            <p>
              DataPresent est une plateforme SaaS qui permet de transformer des données (Excel, CSV,
              PDF, Google Sheets) en présentations visuelles générées par intelligence artificielle.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Le service, y compris son code, design, logo et contenu, est protégé par les droits de
              propriété intellectuelle. Vous conservez la propriété des données que vous uploadez,
              mais nous conservons tous droits sur le service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Les abonnements sont facturés mensuellement ou annuellement selon le plan choisi. Vous
              pouvez résilier à tout moment depuis votre espace client. Les frais ne sont pas
              remboursables au prorata.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              DataPresent est fourni &quot;en l&apos;état&quot;. Nous ne garantissons pas que le
              service sera toujours disponible, sans erreur ou que les résultats générés répondront
          ...
          <section>
            ...
            <p>
              Vous acceptez d&apos;indemniser et de dégager DataPresent de toute responsabilité pour
              toutes réclamations résultant de votre utilisation du service ou de votre violation de
              ces conditions.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Nous nous réservons le droit de suspendre ou résilier votre compte si vous violates
              ces conditions ou si nous soupçonnons une activité frauduleuse ou illégale.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              vigueur dès leur publication. Votre utilisation continue du service vaut acceptation
          ...
          <section>
            ...
            <p>
              ...
              <strong>legal@datapresent.com</strong>
            </p>
          </section>
        </div>
      </div>
