      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p>
              La présente politique de confidentialité décrit comment DataPresent collecte, utilise
              et protège vos données personnelles. En utilisant notre service, vous acceptez les
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>
                <strong>Informations de compte</strong> : nom, email, mot de passe chiffré
              </li>
              <li>
                <strong>Données dorganisation</strong> : nom de lorganisation, logo, préférences
              </li>
              <li>
                <strong>Données de rapport</strong> : fichiers uploadés, slides générées,
                commentaires
              </li>
              <li>
                <strong>Données dutilisation</strong> : statistiques dutilisation, logs
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Nous mettons en œuvre des mesures de sécurité appropriées : chiffrement des données en
              transit et au repos, authentification sécurisée, accès restreint aux données
              personnelles, audits de sécurité réguliers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Nous ne vendons pas vos données personnelles. Nous partageons certaines données avec
              des tiers fournisseurs de services (hébergement, paiement, IA) uniquement pour la
          ...
          <section>
            ...
            <p>
              ...
              analytiques anonymes. Vous pouvez gérer vos préférences cookies dans votre navigateur.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Les données sont conservées pendant la durée de votre abonnement et pendant une
              période supplémentaire de 3 ans à des fins légales et de support client.
            </p>
          </section>
