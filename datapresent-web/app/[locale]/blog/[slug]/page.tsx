...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  const relatedPosts = allPosts.filter((p) => p.locale === locale && p.slug !== slug).slice(0, 3);
  ...
  const jsonLd = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: `${process.env.NEXT_PUBLIC_BASE_URL || "https://datapresent.com"}/logo.png`,
      },
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      ...
      <main className="flex-1">
        ...
        <header className="border-b border-border">
          <div className="max-w-4xl mx-auto px-6 py-12 md:py-16">
            ...
            {/* Description */}
            <p className="text-lg md:text-xl text-muted-foreground mb-8">{post.description}</p>
